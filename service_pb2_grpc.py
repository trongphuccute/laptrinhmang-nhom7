...
class UserValidationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CheckUserStatus = channel.unary_unary(
                '/UserValidation/CheckUserStatus',
...
class UserValidationServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_UserValidationServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'UserValidation', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('UserValidation', rpc_method_handlers)
